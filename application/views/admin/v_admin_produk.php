...
<head>
  ...
  <title>UMKM GLAGAH | List Produk</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
          ...
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table-responsive-md" style="font-size:13px;">
                    <thead>
                      <tr>
                        <th>Gambar</th>
                        <th>Nama Produk</th>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2022 TEAM KKN UNY 2022</strong> All rights reserved. | Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>Team KKN</a>
    </footer>
